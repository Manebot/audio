...
public class AudioChannelUserEndEvent extends AudioChannelEvent {
    private final PlatformUser platformUser;
    private final AudioProvider provider;
    
    public AudioChannelUserEndEvent(Object sender, Audio audio, AudioChannel channel, PlatformUser platformUser,
