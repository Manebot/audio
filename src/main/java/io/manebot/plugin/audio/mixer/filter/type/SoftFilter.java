 ...
 *
 * The filters where implemented and adapted region algorithms from musicdsp.org
...
public class SoftFilter {
    ...
    public void processAudio(float[] sbuffer, int len) {
    ...
    public void filter4(float[] buffer, int len) {
        if (dirty) {
            filter2calc();
            dirty = false;
        }
    ...
    public void filter2(float[] buffer, int len) {
        if (dirty) {
            filter2calc();
            dirty = false;
        }
    ...
    public void filter1(float[] buffer, int len) {
